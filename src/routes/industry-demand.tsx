...
export const Route = createFileRoute("/industry-demand")({
  head: () => ({
    meta: [{ title: "Industry Demand Intelligence — CognifyAI" }],
  }),
      ...
      <AppShell>
        ...
        <div className="rounded-3xl p-6 bg-card border border-destructive/20 text-center space-y-4 max-w-sm mx-auto mt-10">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            Skill test) to unlock Market Demand Intelligence!
          </p>
        </div>
      </AppShell>
    );
  ...
  return (
    <AppShell>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-white/95 mt-1">
              Average wages up 14.5% year-over-year
            </p>
          </div>
      ...
      <h3 className="text-base font-bold mb-3 flex items-center gap-1.5">
        <TrendingUp className="h-5 w-5 text-primary" /> Hiring & Salary Demand
      </h3>
            ...
            <div className="grid grid-cols-2 gap-2 mt-3">
              <div className="p-3 bg-muted/40 rounded-xl">
                ...
                <p className="text-sm font-bold mt-0.5">
                  {c.openings.toLocaleString()} roles
                </p>
              </div>
              <div className="p-3 bg-muted/40 rounded-xl">
