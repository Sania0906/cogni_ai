...
function SkillGrowth() {
      ...
      <AppShell>
        ...
        <div className="rounded-3xl p-6 bg-card border border-destructive/20 text-center space-y-4 max-w-sm mx-auto mt-10">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            Skill test) to unlock your Skill Growth Engine!
          </p>
        </div>
      </AppShell>
    );
  ...
  const prediction = fastTrack
    ? data.acceleratedStudyPrediction
    : data.predicted;
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-white/95 mt-1">
              On track to achieve Senior standard by Dec
            </p>
          </div>
        ...
        <div className="relative w-full h-44 mt-2 flex flex-col justify-end">
          ...
          >
            ...
            <path
              ...
              fill="none"
              stroke={
                fastTrack ? "oklch(0.65 0.24 350)" : "oklch(0.55 0.24 280)"
              }
              strokeWidth="2"
              strokeDasharray="2,2"
              strokeLinecap="round"
            ...
            <circle
              ...
              cy={fastTrack ? 12 : 13}
              r="1.5"
              fill={fastTrack ? "oklch(0.65 0.24 350)" : "oklch(0.55 0.24 280)"}
            />
            <circle
              cx="83"
              cy={fastTrack ? 10 : 11.5}
              r="1.5"
              fill={fastTrack ? "oklch(0.65 0.24 350)" : "oklch(0.55 0.24 280)"}
            />
            <circle
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="p-4 rounded-2xl bg-card shadow-card">
          ...
          <p className="text-lg font-bold mt-1.5">
            {fastTrack ? "12-15 hours" : "5-6 hours"}
          </p>
        ...
        <div className="p-4 rounded-2xl bg-card shadow-card">
          ...
          <p className="text-lg font-bold mt-1.5">
            {fastTrack ? "3.5 months" : "7.2 months"}
          </p>
