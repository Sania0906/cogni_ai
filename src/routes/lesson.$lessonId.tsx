  ...
  return (
    <div className="mx-auto max-w-md min-h-screen pb-10">
      <div className="relative aspect-video bg-gradient-primary flex items-center justify-center">
        <Link
          to="/course/$courseId"
          params={{ courseId: "ml-foundations" }}
          className="absolute top-4 left-4 h-10 w-10 rounded-xl bg-black/30 backdrop-blur flex items-center justify-center text-white"
        >
      ...
      <div className="px-5 pt-6">
        ...
        <p className="text-sm text-muted-foreground mt-2">
          Apply core ML concepts by building your first model from scratch.
        </p>

        <div className="flex justify-center gap-4 mt-6">
          <button className="h-12 w-12 rounded-2xl bg-card shadow-card flex items-center justify-center">
            <SkipBack className="h-5 w-5" />
          </button>
          <button className="h-14 w-14 rounded-2xl bg-gradient-primary text-white shadow-glow flex items-center justify-center">
