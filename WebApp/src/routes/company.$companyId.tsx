  ...
  return (
    <AppShell>
      ...
      <div className="rounded-3xl p-6 bg-card shadow-card text-center">
        <div className="h-20 w-20 rounded-3xl bg-gradient-primary text-white flex items-center justify-center font-bold text-2xl mx-auto">
          CL
        </div>
        ...
        <div className="flex justify-center gap-4 mt-4 text-xs text-muted-foreground">
          <span className="flex items-center gap-1">
            <MapPin className="h-3.5 w-3.5" /> Remote-first
          </span>
          <span className="flex items-center gap-1">
            <Users className="h-3.5 w-3.5" /> 240+
          </span>
          <span className="flex items-center gap-1">
      ...
      <div className="grid grid-cols-3 gap-3 mt-4">
        {[
          ...
          <div
            key={s.l}
            className="rounded-2xl bg-card p-3 shadow-card text-center"
          >
      ...
      <p className="text-sm text-muted-foreground leading-relaxed">
        Cognify Labs builds developer-grade ML platforms used by 4,000+
        companies worldwide.
      </p>

      <h3 className="text-lg font-bold mt-6 mb-3">Open Roles</h3>
      <div className="space-y-3">
        {["Senior ML Engineer", "Frontend Engineer", "Research Scientist"].map(
          (r, i) => (
            <Link
              key={r}
              to="/job/$jobId"
