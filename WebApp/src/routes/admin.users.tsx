...
const users = [
  {
    name: "Alex Morgan",
    email: "alex@cognify.ai",
    role: "Pro",
    status: "Active",
  },
  {
    name: "Priya Shah",
    email: "priya@cognify.ai",
    role: "Admin",
    status: "Active",
  },
  {
    name: "Marco Reyes",
    email: "marco@cognify.ai",
    role: "Free",
    status: "Active",
  },
  {
    name: "Lin Park",
    email: "lin@cognify.ai",
    role: "Pro",
    status: "Suspended",
  },
  {
      ...
      <div className="rounded-2xl bg-card shadow-card overflow-hidden">
        {users.map((u, i) => (
          ...
          >
            ...
            <span
              className={`px-2 py-0.5 rounded-full text-[10px] font-bold ${statusColor[u.status as keyof typeof statusColor]}`}
            >
              {u.status}
            </span>
            <button>
