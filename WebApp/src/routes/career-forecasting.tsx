      ...
      <AppShell>
        ...
        <div className="rounded-3xl p-6 bg-card border border-destructive/20 text-center space-y-4 max-w-sm mx-auto mt-10">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            Skill test) to unlock your AI Career Forecasting!
          </p>
        </div>
      </AppShell>
    );
  ...
  return (
    <AppShell>
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="text-xs uppercase tracking-wider font-semibold text-white/80">
              Future Market Trends (5-10 Yrs)
            </p>
            <h2 className="text-2xl font-bold mt-1">
              Cognitive Automation Era
            </h2>
            <p className="text-sm text-white/95 mt-1">
              65% of current entry-level IT tasks automated
            </p>
          </div>
      ...
      <h3 className="text-base font-bold mb-3 flex items-center gap-1.5">
        <BarChart3 className="h-5 w-5 text-primary" /> Automation Risk & Growth
      </h3>
        ...
        {data.roles.map((item) => (
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <span className="font-bold text-sm leading-tight max-w-[70%]">
                {item.name}
              </span>
              <span
              ...
              <div>
                <div className="flex justify-between text-[10px] text-muted-foreground mb-1 font-semibold">
                  <span className="flex items-center gap-0.5">
                    <ShieldAlert className="h-3 w-3" /> AI Automation Risk
                  </span>
                  <span>{item.risk}%</span>
                </div>
      ...
      <div className="p-5 rounded-2xl bg-card shadow-card">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed">
          The best defense against high automation risk is{" "}
          <span className="font-semibold text-foreground">
            deep specialized reasoning (ML systems design, security)
          </span>{" "}
          combined with{" "}
          <span className="font-semibold text-foreground">
            domain specific translation
          </span>
          . Standard boilerplate coding is easily automated, whereas complex
          microservice integrations and organizational workflows remain highly
          human-dependent.
        </p>
      </div>
    </AppShell>
